...
import PorcelainStoneware3 from '../../components/UI/Banners/PorcelainStoneware3';
...
const BannersBottom: React.FC<Props> = ({ loadingFetch, banners }) => {
  ...
  const BannersSort = banners.filter((item) => item.typeBanner === 'bottom');
